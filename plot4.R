...
par(mfrow=c(2,2))
plot(meh$datetime,meh$Global_active_power,type="l",xlab="",ylab="Global Active Power")
plot(meh$datetime,meh$Voltage,type="l",xlab="datetime",ylab="Voltage")
...
plot(meh$datetime,meh$Global_reactive_power,type="l",xlab="datetime",ylab="Global_reactive_power")
dev.off()